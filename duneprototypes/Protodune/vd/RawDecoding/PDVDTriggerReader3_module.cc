...
class PDVDTriggerReader3;

class PDVDTriggerReader3 : public art::EDProducer {
public:
  explicit PDVDTriggerReader3(fhicl::ParameterSet const& p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  PDVDTriggerReader3(PDVDTriggerReader3 const&) = delete;
  PDVDTriggerReader3(PDVDTriggerReader3&&) = delete;
  PDVDTriggerReader3& operator=(PDVDTriggerReader3 const&) = delete;
  PDVDTriggerReader3& operator=(PDVDTriggerReader3&&) = delete;
...
PDVDTriggerReader3::PDVDTriggerReader3(fhicl::ParameterSet const& p)
  : EDProducer{p},
...
void PDVDTriggerReader3::produce(art::Event& e)
{
...
DEFINE_ART_MODULE(PDVDTriggerReader3)
