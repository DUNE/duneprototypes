...
class PDHDDataInterfaceWIB3 : public PDSPTPCDataInterfaceParent {
...
public:
  ...
  explicit PDHDDataInterfaceWIB3(fhicl::ParameterSet const& p)
...
DEFINE_ART_CLASS_TOOL(PDHDDataInterfaceWIB3)
